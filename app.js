...
// }
// /* welcome */
// .box:nth-child(1){ grid-column: span 7; height: 33em;}
// /* links */
// .box:nth-child(4){ grid-row: span 1; order:1; padding: 10px;}
// .links div{
//   display: flex;
...
// /* about */
// .box:nth-child(5){ grid-column: span 5;  grid-row: span 3; order: 5;}
// /* cv */
// .box:nth-child(9){order: 6;}
// /* skills */
// .box:nth-child(6){ grid-column: span 9; order: 7}
// /* learning */
// .box:nth-child(7){ grid-column: span 9; order: 8}
// /* map */
// .box:nth-child(13){ grid-column: span 5; grid-row: span 2; order:9;}
// .map img{
//   max-width: 20%;
// }
// .map p{
...
// }
// /* age */
// .box:nth-child(11){ grid-column: span 3; grid-row: span 1; order:10;}
// /* english */
// .box:nth-child(8){ grid-column: span 2; grid-row: span 2; order:11;}
// /* japanese */
// .box:nth-child(10){ grid-column: span 2; grid-row: span 2; order:12;}
// /* counter */
// .box:nth-child(12){ grid-column: span 3; grid-row: span 1; order:13;}
// /* projects */
// .box:nth-child(14){order:14;}
// /* contact */
// .box:nth-child(15){ grid-column: span 9; grid-row: span 3; order:15;}
// /* footer */
